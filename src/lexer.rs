...
";
        let expected: &[Res<token::Token>] = &[
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 2, 1)),
            Ok(token::Token::new(
                token::Kind::Implies,
                "=>".to_string(),
                2,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 2, 6)),
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 3, 1)),
            Ok(token::Token::new(token::Kind::Or, "|".to_string(), 3, 2)),
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 3, 4)),
            Ok(token::Token::new(
                token::Kind::SemiColon,
                ";".to_string(),
                3,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 4, 1)),
            Ok(token::Token::new(token::Kind::And, "&".to_string(), 4, 3)),
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 4, 5)),
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 5, 1)),
            Ok(token::Token::new(
                token::Kind::Equiv,
                "<=>".to_string(),
                5,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 5, 6)),
            Ok(token::Token::new(
                token::Kind::SemiColon,
                ";".to_string(),
                5,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 6, 2)),
            Ok(token::Token::new(
                token::Kind::SemiColon,
                ";".to_string(),
                6,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 7, 1)),
            Ok(token::Token::new(token::Kind::And, "&".to_string(), 7, 2)),
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 7, 3)),
            Ok(token::Token::new(
                token::Kind::ParenL,
                "(".to_string(),
                8,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "x".to_string(), 8, 2)),
            Ok(token::Token::new(token::Kind::Or, "|".to_string(), 8, 4)),
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 8, 6)),
            Ok(token::Token::new(
                token::Kind::ParenR,
                ")".to_string(),
                8,
            ...
            Ok(token::Token::new(token::Kind::Identifier, "y".to_string(), 10, 6)),
            Ok(token::Token::new(
                token::Kind::Identifier,
                "x".to_string(),
                11,
